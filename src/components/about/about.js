                ...
                <div className="row align-items-center justify-content-lg-between">
                    <div className="col-lg-6">
                        <div className="about_image_1">
                            ...
                            <img src={about2} data-parallax='{"y" : 80, "smoothness": 6}' alt="Devabyte - About" />
                            <img src={about3} data-parallax='{"y" : -80, "smoothness": 6}' alt="Devabyte - About" />
                        </div>
                    </div>
                        ...
                        <div className="about_content">
                            <div className="heading_block">
                                ...
                                <p className="heading_description mb-0">
                                    At Devabyte, our commitment to client satisfaction is at the core of everything we do. We understand clients' success.
                                </p>
                            </div>
